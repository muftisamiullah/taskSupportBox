        ...
        <div class="heading-holder"></div>
          <div class="row">
            <div class="col-sm-3">
              ...
              <a class="apro" href="#">
              <figure class="product-icons ladders"></figure>Aluminium Scaffolding
              </a>
            </div>
          <div class="col-sm-3">
              <img class="imgs3" src="images/aluminium-podium-scaffolding.jpg">
              <a class="apro" href="#">
              <figure class="product-icons ladders"></figure>Aluminium Ladders
              </a>
          </div>
          <div class="col-sm-3">
              <img class="imgs3" src="images/aluminium-mobile-narrow-scaffolding.jpg">
              <a class="apro" href="#">
              <figure class="product-icons ladders"></figure>Steel Cots
              </a>
          </div>
          <div class="col-sm-3">
              <img class="imgs3" src="images/aluminium-folding-scaffolding.jpg">
              <a class="apro" href="#">
              <figure class="product-icons ladders"></figure>Steel Furniture
              </a>
          </div>
        </div>
      </div><br><br><br>
